...
cls
echo ===============================================================================================================
echo #                                    Menu Scripts 1.11 SoftwareDATA Edition                                   #
echo ===============================================================================================================
echo #                                                                                                             #
...
cls
start "web" "https://github.com/abbodi1406/vcredist/releases"
echo Vá até assets, baixe o "VisualCppRedist_AIO_x86_x64.exe" e execute.
pause
goto apps

:mas
cls
start "ps" /wait powershell.exe -command "irm https://get.activated.win | iex"
...
:inventario
cls
set /p setor=Insira a TAG:
winget install glpi-agent --custom="SERVER='https://chamados.softwaredata.com.br' RUNNOW=1 TAG=%setor% AGENTMONITOR=1"
pause
goto apps
